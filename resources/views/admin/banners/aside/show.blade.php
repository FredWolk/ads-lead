            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        <h1 class="m-0 mr-5">Редактирование баннера - {{ $aside->id }}</h1>
                        <a class="text-success mr-5" href="{{ route('aside.edit', $aside->id) }}"><i
                    ...
                    <div class="col-12 table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($aside->type == 'image')
                                        <img loading="lazy" width="400" src="{{ asset('storage/'.$aside->file) }}"
                                             alt="">
                                    @else
                                        <video width="500" controls="controls"
                                               src="{{ asset('storage/'. $aside->file) }}"></video>
                                    @endif
                                </td>
                            </tr>
                            <tr>
