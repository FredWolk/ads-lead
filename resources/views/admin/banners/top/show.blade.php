            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        <h1 class="m-0 mr-5">Редактирование баннера - {{ $top->id }}</h1>
                        <a class="text-success mr-5" href="{{ route('top.edit', $top->id) }}"><i class="fas fa-pen"></i></a>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <video width="500" autoplay controls="controls"
                                               src="{{ asset('storage/'. $top->file) }}"></video>
                                    @endif
                                </td>
                            </tr>
                            <tr>
