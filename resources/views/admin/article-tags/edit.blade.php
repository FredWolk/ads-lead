    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Редактирование хештега - {{ $article_tag->tag_name }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin') }}">Главная</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('article-tags.index') }}">Хештеги</a></li>
                            <li class="breadcrumb-item active">Изменить Хештег</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="card card-primary">
                    ...
                    <form enctype="multipart/form-data" method="post"
                          action="{{ route('article-tags.update', $article_tag->id) }}">
                        @csrf
                        @method('patch')
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="name" name="tag_name" class="form-control select2">
                                    @foreach($all_tags as $i)
                                        <option {{ $i === $article_tag->tag_name ? 'selected' : '' }} value="{{ $i }}">{{ $i }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('tag_name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="link" value="{{ $article_tag->link }}" class="form-control" id="link"
                                       placeholder="Хештег">
                            </div>
                            @error('link')
                            <div class="text-danger">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="summernote" name="seo_text"
                                          id="summernote">{{ $article_tag->seo_text }}</textarea>
                            </div>
                            @error('seo_text')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $article_tag->title }}" name="title" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $article_tag->description }}" name="description" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $article_tag->keywords }}" name="keywords" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $article_tag->og_title }}" name="og_title" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $article_tag->og_description }}" name="og_description" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $article_tag->og_url }}" name="og_url" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $article_tag->og_image }}" name="og_image" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $article_tag->og_type }}" name="og_type" type="text"
                            ...
                            <input value="{{ $article_tag->meta_tags }}" type="hidden" id="meta_tags"
                                   name="meta_tags">
                            <div class="form-group">
                            ...
                            <input value="{{ $article_tag->og_tags }}" type="hidden" name="og_tags">
                            <div class="form-group">
