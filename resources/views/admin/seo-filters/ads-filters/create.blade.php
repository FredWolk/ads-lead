    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Добавить ADS фильтр</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Добавить ADS фильтр</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary">
                    ...
                    <form method="post" action="{{ route('ads-seo-filter.store') }}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="filter_name" class="form-control select1"
                                    ...
                                    @foreach($filters as $i)
                                        <option
                                            {{ old('filter_name') == $i ? 'selected' : '' }} value="{{ $i }}">{{ $i }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('filter_name')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="summernote" name="seo_text"
                                          id="summernote2">{{ old('seo_text') }}</textarea>
                            </div>
                            @error('seo_text')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
