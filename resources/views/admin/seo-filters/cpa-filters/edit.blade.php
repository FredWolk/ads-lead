    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Изменить CPA фильтр</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Изменить CPA фильтр</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary">
                    ...
                    <form method="post" action="{{ route('cpa-seo-filter.update', $cpa_seo_filter->id) }}">
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="filter_name" class="form-control select1"
                                    ...
                                    @foreach($filters as $i)
                                        <option
                                            {{ $cpa_seo_filter->filter_name == $i ? 'selected' : '' }} value="{{ $i }}">{{ $i }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('filter_name')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="summernote" name="seo_text"
                                          id="summernote2">{{ $cpa_seo_filter->seo_text }}</textarea>
                            </div>
                            @error('seo_text')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $cpa_seo_filter->title }}" name="title" type="text"
                                               class="form-control"
                                               id="title"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $cpa_seo_filter->description }}" name="description" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $cpa_seo_filter->keywords }}" name="keywords" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $cpa_seo_filter->og_title }}" name="og_title" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $cpa_seo_filter->og_description }}" name="og_description"
                                               type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $cpa_seo_filter->og_url }}" name="og_url" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $cpa_seo_filter->og_image }}" name="og_image" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $cpa_seo_filter->og_type }}" name="og_type" type="text"
