                    ...
                    <form enctype="multipart/form-data" method="post" action="{{ route('event.store') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pt_name" value="{{ $event->pt_name }}" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pt_location" value="{{ $event->pt_location }}"
                                       class="form-control"
                                       id="pt_location"
                                       placeholder="USA | HOLLYWOOD | FLORIDA">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pt_date" value="{{ $event->pt_date }}" class="form-control"
                                       id="pt_date"
                                       placeholder="1-3 NOVEMBER 2022">
                            </div>
                            @error('pt_date')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input value="{{ $event->pt_image }}" name="pt_image" type="file"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="summernote" name="pt_content"
                                          id="summernote2">{{ $event->pt_content }}</textarea>
                            </div>
                            @error('pt_content')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="card card-success p-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ $event->pt_form_date }}" name="pt_form_date" type="text"
                                           class="form-control"
                                           id="pt_form_date"
                                           placeholder="Lago Events - 6 HaMea VeEsrim St., Rishon LeTsiyon, Israel">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ $event->pt_form_location }}" name="pt_form_location" type="text"
                                           class="form-control"
                                           id="pt_form_location"
                                           placeholder="Lago Events - 6 HaMea VeEsrim St., Rishon LeTsiyon, Israel">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $event->pt_title }}" name="pt_title" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $event->pt_description }}" name="pt_description" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $event->pt_og_title }}" name="pt_og_title" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $event->pt_og_description }}" name="pt_og_description"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $event->pt_og_url }}" name="pt_og_url" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $event->pt_og_image }}" name="pt_og_image" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $event->pt_og_type }}" name="pt_og_type" type="text"
                                    ...
                                    <input value="{{ $event->pt_meta_tags }}" type="hidden" id="pt_meta_tags"
                                           name="pt_meta_tags">
                                    <div class="form-group">
                                    ...
                                    <input value="{{ $event->pt_og_tags }}" type="hidden" name="pt_og_tags">
                                    <div class="form-group">
