                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="active" class="form-control" id="active">
                                    <option {{ $article->active == true ? 'selected' : '' }} value="1">Опубликовать</option>
                                    <option {{ $article->active == false ? 'selected' : '' }} value="0">Отложить</option>
                                </select>
                            </div>
                            @error('active')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" max="4" min="1" name="pin"
                                       value="{{ !empty($article->pin) ? $article->pin : '' }}" class="form-control"
