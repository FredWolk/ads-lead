                            ...
                            <table class="table table-striped projects">
                                ...
                                <tr>
                                    ...
                                    <th class="text-right" style="width: 40%">
                                        <a href="{{ route('video.create') }}" class="btn btn-dark btn-sm">Добавить</a>
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-actions text-right">
                                            <a class="btn btn-primary btn-sm"
                                               href="{{ route('video.show', $i['id']) }}">
                                                <i class="fas fa-folder">
                                                </i>
                                                Просмотр
                                            </a>
                                            <a class="btn btn-info btn-sm" href="{{ route('video.edit', $i->id) }}">
                                            ...
                                            <form id="delete_{{$k}}" method="post"
                                                  action="{{route('video.destroy', $i['id']) }}">
                                                @method('delete')
                                                @csrf
                                            </form>
                                        </td>
