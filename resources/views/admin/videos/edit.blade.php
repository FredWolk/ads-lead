                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Редактировать видео</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary">
                    ...
                    <form enctype="multipart/form-data" method="post" action="{{ route('video.update', $video->id) }}">
                        @method('patch')
                        @csrf
                        <div class="card-body">
                            ...
                            @enderror
                            <div class="form-group">
                                <label for="pt_name">Название видео на португальском</label>
                                <input type="text" name="pt_name" value="{{ $video->pt_name }}" class="form-control"
                                       id="pt_name" placeholder="Название видео">
                            </div>
                            @error('pt_name')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input value="{{ $video->image }}" name="image" type="file"
                            ...
                            @enderror
                            <div class="form-group">
                                <label for="pt_image">Изображение видео на португальском</label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input value="{{ $video->pt_image }}" name="pt_image" type="file"
                                               class="custom-file-input" id="pt_image">
                                        <label class="custom-file-label" for="pt_image">Выберите изображение
                                            видео на португальском</label>
                                    </div>
                                </div>
                            </div>
                            @error('pt_image')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="summernote" name="content"
                                          id="summernote2">{{ $video->content }}</textarea>
                            </div>
                            @error('content')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            <div class="form-group">
                                <label for="summernote2">Контент под видео на португальском
                                </label>
                                <textarea class="summernote" name="pt_content"
                                          id="summernote2">{{ $video->pt_content }}</textarea>
                            </div>
                            @error('pt_content')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->description }}" name="description" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->og_url }}" name="keywords" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->og_url }}" name="og_title" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->og_url }}" name="og_description" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->og_url }}" name="og_url" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->og_image }}" name="og_image" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->og_type }}" name="og_type" type="text"
                                    ...
                                    <input value="{{ $video->meta_tags }}" type="hidden" id="meta_tags"
                                           name="meta_tags">
                                    <div class="form-group">
                                    ...
                                    <input value="{{ $video->og_tags }}" type="hidden" name="og_tags">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->pt_title }}" name="pt_title" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->pt_description }}" name="pt_description" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->pt_keywords }}" name="pt_keywords" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->pt_og_title }}" name="pt_og_title" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->pt_og_description }}" name="pt_og_description"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->pt_og_url }}" name="pt_og_url" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->pt_og_image }}" name="pt_og_image" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $video->pt_og_type }}" name="pt_og_type" type="text"
                                    ...
                                    <input value="{{ $video->pt_meta_tags }}" type="hidden" id="pt_meta_tags"
                                           name="pt_meta_tags">
                                    <div class="form-group">
                                    ...
                                    <input value="{{ $video->pt_og_tags }}" type="hidden" name="pt_og_tags">
                                    <div class="form-group">
