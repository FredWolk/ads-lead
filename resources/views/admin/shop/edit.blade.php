    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Редактировать магазин - {{ $shop->name }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin') }}">Главная</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('shop.index') }}">Магазины</a></li>
                            <li class="breadcrumb-item active">Редактировать магазин</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary">
                    ...
                    <form enctype="multipart/form-data" method="post" action="{{ route('shop.update', $shop->id) }}">
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input value="{{ $shop->image }}" name="image" type="file"
                            ...
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            <img width="150" src="{{ asset('storage/'.$shop->image) }}" alt="">
                            ...
                            <div class="row">
                                <div class="form-group col-4">
                                    ...
                                    <select name="category_id" class="form-control" id="category_id">
                                        ...
                                        <option {{ $shop->category_id == $cat->id ? 'selected' : '' }} value="{{ $cat->id }}">
                                            {{ $cat->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" name="link" value="{{ $shop->link }}" class="form-control"
