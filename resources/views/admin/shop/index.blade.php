                            ...
                            <table class="table table-striped projects">
                                ...
                                <tr>
                                    ...
                                    <th class="text-right" style="width: 40%">
                                        <a href="{{ route('shop.create') }}" class="btn btn-dark btn-sm">Добавить</a>
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($shops as $k => $i)
                                    <tr>
                                        <td>
                                            {{ $k + 1 }}
                                        </td>
                                        ...
                                        <td class="project-actions text-right">
                                            <a class="btn btn-primary btn-sm"
                                               href="{{ route('shop.show', $i['id']) }}">
                                                <i class="fas fa-folder">
                                                </i>
                                                Просмотр
                                            </a>
                                            <a class="btn btn-info btn-sm" href="{{ route('shop.edit', $i['id']) }}">
                                            ...
                                            <form id="delete_{{$k}}" method="post" action="{{route('shop.destroy', $i['id']) }}">
                                                @method('delete')
                                                @csrf
                                            </form>
                                        </td>
