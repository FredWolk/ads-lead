                            ...
                            @foreach ($top_cpa as $k => $i)
                                <li class="main-cpa_aside_list-item">
                                    ...
                                    <div class="main-cpa_aside_list-item_links">
                                        <a data-type="top_pp_{{$k + 1}}_read"
                                           class="link--black-rotateble-arrows banner_check"
                                        ...
                                        <a data-type="top_pp_{{$k + 1}}" target="_blank"
                                           class="link--blue-sphere banner_check" href="{{ $i['url'] }}">
                        ...
                        <ul class="main-cpa_aside_list">
                            @foreach ($top_ads as $k => $i)
                                <li class="main-cpa_aside_list-item">
                                    ...
                                    <div class="main-cpa_aside_list-item_links">
                                        <a data-type="top_cpa_{{$k + 1}}_read"
                                           class="link--black-rotateble-arrows banner_check"
                                        ...
                                        <a data-type="top_cpa_{{$k + 1}}" target="_blank"
                                           class="link--blue-sphere banner_check" href="{{ $i['url'] }}">
                                            <img loading="lazy" src="{{ asset('assets/images/icons/sphere.svg') }}"
                                                 alt="sphere">
                                            <span>Site</span>
