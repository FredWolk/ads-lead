...
<section class="articlespage forumpage">
    <div class="container">
        <h1 class="forumpage-board--title">How To Optimize TikTok Ads Like A Pro: The 5-Step Guide</h1>
                ...
                <button type="button" class="forumpage-board_top-pagin-wrapp-right-more--btn">
                    ...
                    <div class="forumpage-board_top-pagin-wrapp-right-more--body">
                        ...
                        <div class="forumpage-board_top-pagin-wrapp-right-more--body-bot">
                            <a href="{{ route('index') }}" class="forumpage-board_top-pagin-wrapp-right-more--body-link">Edit Topic</a>
                            <a href="{{ route('index') }}" class="forumpage-board_top-pagin-wrapp-right-more--body-link">Delete the topic</a>
                        </div>
                    </div>
                </button>
            </div>
