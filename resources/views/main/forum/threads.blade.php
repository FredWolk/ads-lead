    ...
    <div class="container">
        <section class="cpapage_main">
            <div class="forum_treads_top">
                <h1 class="forum_treads_top-title">TikTok</h1>
                <p class="forum_treads_top-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellen.</p>
                                    ...
                                    <ul class="filter-aside_list-item_wrap_list">
                                        ...
                                        <li class="filter-aside_list-item_wrap_list-item">
                                            <label class="filter-aside_label">
                                                <input class="filter-aside--checkbox" type="checkbox" name="tags" value="#gambling">
            ...
            <ul class="forum_treads_list">
                <li class="forum_treads_list--item">
                    <div class="forum_treads_list--item_left">
                        ...
                        <div class="forum_treads_list--item_left_info">
                            <div class="forum_treads_list--item_left_info_top">
                                ...
                                <a href="{{ route('index') }}" class="forum_main_card_list--item_left-head-title">How To Optimize TikTok Ads Like A Pro: The 5-Step Guide</a>
                            </div>
                    ...
                    <div class="forum_treads_list--item_mid">
                        <p class="forum_treads_list--item_mid-text">Answers: <span>67</span></p>
                        <p class="forum_treads_list--item_mid-text">Viewings: <span>927</span></p>
                    </div>
