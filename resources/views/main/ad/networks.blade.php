        ...
        <section class="cpapage_main">
            ...
            <div class="cpapage_info-wrapper">
                <div class="cpapage_info--block">
                            ...
                            <div class="cpapage_info--item_buttons">
                                ...
                                <a class="btn--grey-with-icons mobile" href="{{ route('index') }}">
                                    <svg width="11" height="12" viewBox="0 0 11 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        adlead.prol
                                        <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.95249 14C1.08411 12.3834 0.328929 10.8532 0.760689 8.76339C1.07943 7.22023 2.12315 5.96472 2.22322 4.42452C2.66906 5.23587 2.85536 5.82092 2.90517 6.66877C4.32318 4.93144 5.26022 2.52637 5.31571 0C5.31571 0 9.00908 2.17012 9.25143 5.4481C9.56938 4.77245 9.72944 3.69936 9.41149 3.00389C10.3653 3.6994 15.9482 9.87366 8.65528 14C10.0264 11.3302 9.00901 7.72787 6.62832 6.06412C6.78732 6.77951 6.50856 9.4477 5.45533 10.6201C5.74716 8.66111 5.17767 7.83276 5.17767 7.83276C5.17767 7.83276 4.9822 8.93005 4.22382 10.0385C3.53129 11.0507 3.05144 12.1251 3.95249 14Z" fill="#181A1C"/></svg>
                                </a>
                            </div>
                        </li>
                        <li class="cpapage_info--item">
                    ...
                    <a style="max-width: 200px; width: 100%;" href="{{ route('cpa') }}" class="btn--grey cpapage_info--block--link">Show all</a>
                </div>
                ...
                <div class="cpapage_info--block">
                    <div class="cpapage_info-header">
                        <h2 class="cpapage_info-title">instant message</h2>
                ...
                <div class="cpapage_info--block">
                    <div class="cpapage_info-header">
                        <h2 class="cpapage_info-title">video im slider</h2>
                        <a class="link--black-rotateble-arrows" href="{{ route('index') }}">
                            <span>See all</span>
                            <div class="link--black-rotateble-arrows-group">
                                @for ($a=0; $a<3; $a++)
