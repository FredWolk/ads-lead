    ...
    <section class="breadcrambs top">
        <div class="container">
            <ul class="breadcrambs_list">
                ...
                <li class="breadcrambs_list-item">
                    {{ !empty($seo) ? $seo["{$locale}h1"] : __('messages.ad') }}
                </li>
            </ul>
        </div>
    </section>
                ...
                <div class="cpapage_main-to-hide" style="margin-block: 25px">
                    ...
                    @if(false)
                        <ul class="cpapage_main-to-show_filter__tags visible">
                            <button type="button" class="cpapage_main-to-show_filter__tags--reset">Remove filters
                            </button>
                            ...
                            @foreach($recomended as $i)
                                ...
                                <li class="cpapage_info--item">
                                    ...
                                    <div class="cpapage_info--item_buttons">
                                        ...
                                        <a data-type="rec_pp_{{$k}}" class="link--blue-sphere banner_check"
                                           target="_blank"
                    ...
                    <div style="width: 100%" class="ad__filters">
                        @foreach($ad->groupBy('main_advertising_formats') as $k => $i)
                            <div class="cpapage_info--block">
                                ...
                                <ul class="cpapage_info-list">
                                    @foreach($i->sortBy('listing_rating') as $v)
                                        ...
                                        ">
                                                ...
                                                <a class="link--blue-sphere" target="_blank"
                                ...
                                <a style="max-width: 200px; width: 100%;" href="{{ route('ad.catalog', $k) }}"
