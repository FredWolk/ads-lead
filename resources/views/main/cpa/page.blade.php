                            ...
                            @if(!empty($cpa['payment_schedule']))
                                <li class="cpaartpage_card_top--item">
                                    <div class="cpaartpage_card_top--item_top">
                                        ...
                                        <p class="cpaartpage_card_top--item_top-text">
                                            {{ __('messages.cpa.payment.method') }}:</p>
                                    </div>
