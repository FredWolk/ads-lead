...
<section class="videopage articlepage">
    <div class="container">
        <div class="articlepage_top"> 
            <h1 class="title">Affiliate Network Review: ADLEADPRO</h1>
            <div class="videopage_main-underimage_autor to-show">
                ...
                <p style="font-size: 14px;" class="videopage_main-underimage_autor-link">by <a href="{{ route('index') }}">Wade Warren</a></p>
            </div>
                    ...
                    <ul class="cpaartpage_card_top">
                        ...
                        <li class="cpaartpage_card_top--item">
                            <div class="cpaartpage_card_top--item_top">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.71682 4.75578L1.83713 4.75578L1.83713 0.918579L15.2673 0.918579L15.2673 14.3488H11.4301L11.4301 7.4691L3.19378 15.7054L0.480469 12.9921L8.71682 4.75578Z" fill="#181A1C"/></svg>                                    
                                <p class="cpaartpage_card_top--item_top-text">Date of creation:</p>
                            </div>
                            <p class="cpaartpage_card_top--item-text">Cryptocurrency, Gambling, Betting, Acting</p>
                        </li>
                        @endfor
                    </ul>
                ...
                <div class="articlepage--comments">
                    ...
                    <div class="articlepage--comments_main">
                        ...
                        <div class="articlepage--comments-none-editorial-opinion">
                            ...
                            <p class="articlepage--comments-none-editorial-opinion-text">The list is not complete, obviously. For each GEO and culture you can find dozens of local holidays (that are easily googleable). The idea is not in the holidays per se, but in the approaches. If you follow the world news, you’ll be able to create an ad for any occasion. Here are some examples of what we worked with when everyone else was using the same old methods. If you follow the world news, you’ll be able to create an ad for any occasion. Here are some examples of what we worked wit.</p>
                        </div>
                    ...
                    <li class="article--card swiper-slide">
                        ...
                        <div class="article--card_info">
                            <ul class="article--card_info_tags-list">
                                ...
                                <li class="article--card_info_tags-list-item">
                                    <a class="article--card_info_tags-list-item--link" href="{{ route('index') }}">#aeting</a>
                                </li>
                                <li class="article--card_info_tags-list-item">
                                    <a class="article--card_info_tags-list-item--link" href="{{ route('index') }}">#gambling</a>
                                </li>
