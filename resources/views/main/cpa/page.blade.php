            ...
            <div class="videopage_wrapper">
                <article class="videopage_main">
                    <div class="videopage_main--image">
                        <img src="{{ asset('storage/'. $cpa["{$locale}image"]) }}" alt="banner">
                    </div>
                    ...
                    <div class="cpaartpage_card">
                        ...
                        <div class="cpaartpage_card_bot">
                            <div class="articlepage--review-integration_autor">
                                <div class="videopage_main-underimage_autor-image">
                                    <img src="{{asset('storage/' . $cpa['manager_image'])}}" alt="autor">
                                </div>
                    ...
                    <div class="articlepage--comments">
                        ...
                        <div class="articlepage--comments_main">
                            ...
                            <div class="articlepage--comments-none-editorial-opinion">
                                ...
                                <p class="articlepage--comments-none-editorial-opinion-text">{{ $cpa['editorial_opinion'] }}</p>
                                ...
                                @if(false)
                                    <ul class="articlepage--comments_main_list">
                                        <li class="articlepage--comments_main_list-item">
                                            ...
                                            <p class="articlepage--comments_main_list-item-text">The list is not
                                                complete,
                                                obviously. For each GEO and culture you can find dozens of local
                                                holidays (that
                                                are easily googleable). <br><br> The idea is not in the holidays per se,
                                                but in
                                                the approaches. If you follow the world news, you’ll be able to create
                                                an ad for
                                                any occasion. Here are some examples of what we worked with when
                                                everyone else
                                                was using the same old methods.</p>
                    ...
                    <div class="cpaartpage_aside_rating">
                        ...
                        <div class="cpaartpage_aside_rating_group">
                            <div class="cpaartpage_aside_rating_group-item">
                                ...
                                <div class="cpaartpage_aside_rating_group-item-num"><span>{{ $cpa['rating_support'] }}</span>/5</div>
                            </div>
                            <div class="cpaartpage_aside_rating_group-item">
                                <div class="articlepage--comments_main_list-item_top_rating-group-item">
                                    <p class="articlepage--comments_main_list-item_top_rating-group-item-name">
                                ...
                                <div class="cpaartpage_aside_rating_group-item-num"><span>{{ $cpa['rating_payments'] }}</span>/5</div>
                            </div>
                            <div class="cpaartpage_aside_rating_group-item">
                                <div class="articlepage--comments_main_list-item_top_rating-group-item">
                                    <p class="articlepage--comments_main_list-item_top_rating-group-item-name">
                                ...
                                <div class="cpaartpage_aside_rating_group-item-num"><span>{{ $cpa['rating_offers'] }}</span>/5</div>
                            </div>
                            <div class="cpaartpage_aside_rating_group-item">
                                <div class="articlepage--comments_main_list-item_top_rating-group-item">
                                    <p class="articlepage--comments_main_list-item_top_rating-group-item-name">
                                ...
                                <div class="cpaartpage_aside_rating_group-item-num"><span>{{ $cpa['rating_betting'] }}</span>/5</div>
                            </div>
                        </div>
                    </div>
                    @if(!empty($banner))
