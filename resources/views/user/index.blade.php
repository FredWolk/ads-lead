    ...
    <section class="user-main">
        <div class="user-main_settings user_card">
            ...
            <form action="" method="GET" class="user-main--status-form">
                <textarea style="height: 117px" class="input-style input-textarea" required placeholder="Set the status to 80 characters, which will be seen by all users on the forum" name="status" maxlength="80"></textarea>
                <button style="max-width: 161px; height: 50px" class="btn--blue header_buttons-blue-btn">
                    <span>Save</span>
                    <img src="{{asset('assets/images/icons/arrow-right-white.svg')}}" alt="arrow">
                </button>
