            ...
            <div class="header_nav-wrapper">
                ...
                <div class="header_buttons">
                    ...
                    <button type="button" class="btn-rectangle btn--notif header--notif-btn">
                        <svg class="svg1" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_1256_17647)"><path d="M5.6875 13.25C5.6875 13.5981 5.82578 13.9319 6.07192 14.1781C6.31806 14.4242 6.6519 14.5625 7 14.5625C7.3481 14.5625 7.68194 14.4242 7.92808 14.1781C8.17422 13.9319 8.3125 13.5981 8.3125 13.25" stroke="#272C31" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M12.6875 11.9375C12.6875 11.9375 11.375 9.75 11.375 8V5.8125C11.375 4.65218 10.9141 3.53938 10.0936 2.71891C9.27312 1.89844 8.16032 1.4375 7 1.4375C5.83968 1.4375 4.72688 1.89844 3.90641 2.71891C3.08594 3.53938 2.625 4.65218 2.625 5.8125V8C2.625 9.75 1.3125 11.9375 1.3125 11.9375H12.6875Z" stroke="#272C31" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></g><defs><clipPath id="clip0_1256_17647"><rect width="14" height="16" fill="white"/><rect width="14" height="14" fill="white"/></clipPath></defs></svg>
                        
                        <svg class="svg2" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="0.5" y="0.5" width="39" height="39" fill="#014EFF" stroke="#014EFF"/><rect x="25.832" y="13" width="1.64975" height="18.1473" transform="rotate(45 25.832 13)" fill="white"/><rect x="13" y="14.1665" width="1.64975" height="18.1473" transform="rotate(-45 13 14.1665)" fill="white"/></svg>            
...
<section class="breadcrambs top user">
    <div class="container">
        <ul class="breadcrambs_list">
            ...
            <li class="breadcrambs_list-item">
                <a href="{{ route('user.index') }}">Personal Cabinet</a> {{-- CCOM нужно сделать, чтобы ссылка и название бралось с текущей страницы --}}
            </li>
        </ul>
    </div>
</section>
...
<div class="container user-wrapper">
    <nav class="user_nav">
        <div class="user_nav_first">
            <div class="user_nav_top">
                <div class="user_nav-avatar-wrapper">
                    ...
                    <button type="button" class="user_nav-avatar-download--btn"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" fill="#014EFF" stroke="white" stroke-width="2"/><path d="M15.5 10.5H13.5V7.5H10.5V10.5H8.5L12 14L15.5 10.5ZM8.5 15V16H15.5V15H8.5Z" fill="white"/></svg></button>
                </div>
            ...
            <ul class="user_nav-menu_list">
                ...
                <li class="user_nav-menu--item active">
                    <a href="{{ route('user.index') }}" class="user_nav-menu--link">
                        ...
                        <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.87684 4.5H3.49816V1.5H13.9982V12H10.9982V6.62132L4.55882 13.0607L2.4375 10.9393L8.87684 4.5Z" fill="#181A1C"/></svg>                        
                    </a>
                </li>
        ...
        <div class="user_nav_first-last">
            ...
            <button type="button" class="user_nav-exit--btn">
                <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.25552 6L10.0588 2.1967L7.9375 0.0753784L0.512879 7.5L7.9375 14.9246L10.0588 12.8033L6.25552 9L15.3621 9L15.3621 6H6.25552Z" fill="#181A1C"/></svg>
                <span>exit</span>
            </button>
        </div>
    </nav>
